...
PLAYWRIGHT_CONFIG = {
    ...
    "browsers": [
        ...
        {"name": "chromium", "channel": "chrome"},  # Latest 2 Chrome versions via channel
...
def get_context_config():
    ...
    return {
        ...
        "record_video_dir": f"{PLAYWRIGHT_CONFIG['output_dir']}/videos" if PLAYWRIGHT_CONFIG["video"] != "off" else None,
