...
class TestAPIClient:
    ...
    def test_successful_get_request(self, mock_request, api_client):
        ...
        mock_request.assert_called_once_with(
            "GET", "http://test-api:8000/test-endpoint", timeout=5, params=None
        )
    ...
    def test_successful_post_request(self, mock_request, api_client):
        ...
        mock_request.assert_called_once_with(
            "POST", "http://test-api:8000/test-endpoint", timeout=5, json=test_data
        )
    ...
    def test_successful_put_request(self, mock_request, api_client):
        ...
        mock_request.assert_called_once_with(
            "PUT", "http://test-api:8000/test-endpoint", timeout=5, json=test_data
        )
    ...
    def test_successful_delete_request(self, mock_request, api_client):
        ...
        assert result == {}
        mock_request.assert_called_once_with(
            "DELETE", "http://test-api:8000/test-endpoint", timeout=5
        )
    ...
    def test_health_check_success(self, mock_request, api_client):
        ...
        mock_request.assert_called_once_with(
            "GET", "http://test-api:8000/health/live", timeout=5, params=None
        )
    ...
    def test_get_with_params(self, mock_request, api_client):
        ...
        mock_request.assert_called_once_with(
            "GET", "http://test-api:8000/test-endpoint", timeout=5, params=params
        )
