...
from flask_admin.config import configure_for_hf_spaces, is_hf_spaces, get_hf_space_url
...
def validate_hf_spaces_config():
    ...
    if is_hf_spaces():
        ...
        print("💡 Configure missing variables in HF Spaces Settings > Repository secrets")
